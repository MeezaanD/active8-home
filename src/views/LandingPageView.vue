    ...
    <section id="about">
      <div class="container-about">
          <div class="row align-items-start">
            ...
            <div class="col-lg-6">
              <h2 class="about-heading"><img src="https://i.postimg.cc/13vwVPb9/transparent.png" style="height:7rem;margin-top:10px" alt=""> provides all types of fitness outfit and equipment. They include :</h2>
